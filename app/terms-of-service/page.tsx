    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 py-12">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8">
          ...
          <p className="text-sm text-gray-600 dark:text-gray-400 mb-8">Last updated: November 10, 2025</p>
          ...
          <div className="prose dark:prose-invert max-w-none">
            ...
            <section className="mb-8">
              ...
              <p className="mb-4">
                This policy is in place because digital content is immediately accessible upon purchase, 
                and our service is consumed at the time of purchase. No physical products are involved.
              </p>
              <p className="mb-4">
                However, we will assist with technical issues, duplicate charges, or billing errors. 
